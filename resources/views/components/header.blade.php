<div class="fixed top-0 bg-white shadow-md z-50 w-full">
        ...
        <div
            ...
            <div class="hidden md:flex-1 md:flex md:items-center md:justify-between">
                ...
                <div class="flex items-center md:ml-12">
                    ...
                    <div class="flex items-center md:pl-4" style="box-shadow: 0.3px 0 #888888 inset;">
                        <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">
                            Sign in
                        </a>
                        <a href="#"
                            class="ml-4 inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-red-600 hover:bg-red-700">
                            Sign up
                        </a>
                    </div>
                    <div class="hidden relative pl-1" style="box-shadow: 0.3px 0 #888888 inset;">
                        <button type="button"
                            class="bg-white rounded-md p-2 inline-flex items-center justify-center text-black hover:text-black hover:bg-gray-100"
                        ...
                        <div class="hidden absolute w-48 z-30 top-11 right-0 bg-white" id="profile-modal">
                            <div
                                class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
                                <div class="py-3 px-2">
                                    <div class="grid grid-cols-1">
                                        <a href="#"
                                            class="flex p-3 rounded-md text-base font-medium text-gray-900 hover:text-gray-700 hover:bg-gray-100">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                                <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div class="absolute z-30 top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden" id="mobile-nav">
        <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
            <div class="pt-5 pb-6 px-5 sm:pb-8">
                <div class="flex items-center justify-between">
                    <div>
                        <img class="h-8 w-auto" src="/assets/logotype.png" alt="Workflow">
                    </div>
                    <div class="-mr-2">
                        <button type="button"
                            class="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-red-500"
            ...
            <div class="py-6 px-5">
                <div class="grid grid-cols-1 gap-4">
                    ...
                    {{-- <div class="grid grid-cols-1 gap-4"> --}} <div class="hidden">
                        <a href="#"
                            class="flex rounded-md text-base font-medium text-gray-900 hover:text-gray-700">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
