    ...
    <div class="bg-white">
        <main>
            ...
            <div class="relative overflow-hidden pt-16">
                <img src="assets/greysiapolii-banner.jpg" class="absolute inset-0 h-full w-full object-cover -z-10" alt="">
                <div
                    class="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl lg:grid lg:grid-cols-2 lg:gap-24 z-10">
                    <div class="mt-20">
                        <div class="mt-6 sm:max-w-xl">
                            ...
                            <p class="mt-6 text-xl text-gray-500">
                                Platform all-in-one untuk sewa lapangan, cari lawan sparring, atau cari kawan main
                                bareng.
                        ...
                        <div class="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0 lg:max-w-none lg:py-20">
                            ...
                            <div class="relative pt-64 pb-10 rounded-2xl shadow-xl overflow-hidden">
                                ...
                                <div class="relative px-8">
                                    <div>
                                        <img class="h-12" src="/img/logos/workcation.svg?color=white" alt="Workcation">
                                    </div>
                    ...
                    <div class="lg:grid lg:grid-cols-2 lg:gap-24 lg:items-center">
                        ...
                        <div class="mt-12 grid grid-cols-2 gap-0.5 md:grid-cols-3 lg:mt-0 lg:grid-cols-2">
                            <div class="col-span-1 flex justify-center py-8 px-8 bg-gray-50">
                                <img class="max-h-12" src="/img/logos/transistor-logo-gray-400.svg" alt="Transistor">
                            </div>

                            <div class="col-span-1 flex justify-center py-8 px-8 bg-gray-50">
                                <img class="max-h-12" src="/img/logos/mirage-logo-gray-400.svg" alt="Mirage">
                            </div>

                            <div class="col-span-1 flex justify-center py-8 px-8 bg-gray-50">
                                <img class="max-h-12" src="/img/logos/tuple-logo-gray-400.svg" alt="Tuple">
                            </div>

                            <div class="col-span-1 flex justify-center py-8 px-8 bg-gray-50">
                                <img class="max-h-12" src="/img/logos/laravel-logo-gray-400.svg" alt="Laravel">
                            </div>

                            <div class="col-span-1 flex justify-center py-8 px-8 bg-gray-50">
                                <img class="max-h-12" src="/img/logos/statickit-logo-gray-400.svg" alt="StaticKit">
                            </div>

                            <div class="col-span-1 flex justify-center py-8 px-8 bg-gray-50">
                                <img class="max-h-12" src="/img/logos/workcation-logo-gray-400.svg" alt="Workcation">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="relative">
                            ...
                            <form action="#" class="mt-12 sm:mx-auto sm:max-w-lg sm:flex">
                                ...
                                <div class="mt-4 sm:mt-0 sm:ml-3">
                                    <button type="submit"
                                        class="block w-full rounded-md border border-transparent px-5 py-3 bg-gray-900 text-base font-medium text-white shadow hover:bg-black focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-rose-500 sm:px-10">Notify
                                        me</button>
                                </div>
                            </form>
                        </div>
